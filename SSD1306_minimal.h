/*
  ...
  Modified by: CoPiino Electronics (http://copiino.cc)
      ...
      What is it?
        This library is derived from cOLED library, only for SSD1306 in I2C Mode.
...
class SSD1306_Mini {
public:
  SSD1306_Mini(const uint8_t addr) : _i2cAddr(addr) {};
  ...
  void printChars(char ch, uint8_t num); // print one char many times
